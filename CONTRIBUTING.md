...
The following applies to code changes to the Betfint Core project, and is not to be
confused with overall Betfint Network Protocol consensus changes.
