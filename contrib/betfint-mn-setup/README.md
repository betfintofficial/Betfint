# Betfint Coin Masternode Setup Guide (Ubuntu 16.04 and above)
This guide will assist you in setting up a Betfint Masternode on a Linux Server running Ubuntu 16.04 and above. (Use at your own risk)

If you require further assistance contact the support team @ [Discord](https://discord.gg/Nu2PAt)
***
## Requirements
1) **25,000  Betfint coins.**
...
`wget -q https://raw.githubusercontent.com/betfint/contrib/betfint-mn-setup/betfint_install.sh`
***

***Step 8***
* Paste the code below into the Bitvise terminal then press enter

`bash betfint_install.sh`
...
***Step 1***
* Download and install the Betfint wallet [here](https://github.com/betfint/betfint/releases)
***

***Step 2***
* Send EXACTLY 25,000 BETF to a receive address within your wallet.
***
