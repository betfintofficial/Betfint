...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='betfint.conf'
CONFIGFOLDER='/root/.betfint'
COIN_DAEMON='betfintd'
COIN_CLI='betfint-cli'
COIN_PATH='/usr/local/bin/'
COIN_REPO='https://github.com/betfint/betfint.git'
COIN_TGZ='https://github.com/betfint/betfint/releases/download/v2.0.0/betfint-2.0.0-x86_64-linux-gnu.tar.gz'
