...
RESOURCES += src/qt/betfint.qrc src/qt/betfint_locale.qrc

TRANSLATIONS += src/qt/locale/betfint_bg.ts \
                src/qt/locale/betfint_de.ts \
                src/qt/locale/betfint_en.ts \
                src/qt/locale/betfint_es.ts \
                src/qt/locale/betfint_fi.ts \
                src/qt/locale/betfint_fr.ts \
                src/qt/locale/betfint_it.ts \
                src/qt/locale/betfint_ja.ts \
                src/qt/locale/betfint_pl.ts \
                src/qt/locale/betfint_pt.ts \
                src/qt/locale/betfint_ru.ts \
                src/qt/locale/betfint_sk.ts \
                src/qt/locale/betfint_sv.ts \
                src/qt/locale/betfint_vi.ts \
                src/qt/locale/betfint_zh_CN.ts \
                src/qt/locale/betfint_zh_TW.ts
