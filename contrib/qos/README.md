...
This means one can have an always-on betfintd instance running, and another local betfintd/betfint-qt instance which connects to this node and receives blocks from it.
