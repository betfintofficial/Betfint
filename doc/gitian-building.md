...
*Setup instructions for a Gitian build of Betfint Core using a VM or physical system.*
...
- [Building Betfint Core](#building-betfint)
...
- [LXC](https://linuxcontainers.org/), see also [Gitian host docker container](https://github.com/gdm85/tenku/tree/master/docker/gitian-betfint-host/README.md).
...
At this point you have two options, you can either use the automated script (found in [https://github.com/betfint/betfint/blob/master/contrib/gitian-build.sh](https://github.com/betfint/betfint/blob/master/contrib/gitian-build.sh), only works in Debian/Ubuntu) or you could manually do everything by following this guide.
...
Follow the instructions in [https://github.com/betfint/betfint/blob/master/doc/release-process.md](https://github.com/betfint/betfint/blob/master/doc/release-process.md#fetch-and-create-inputs-first-time-or-when-dependency-versions-change)
in the betfint repository under 'Fetch and create inputs' to install sources which require
...
Gitian builds' in [https://github.com/betfint/betfint/blob/master/doc/release-process.md](https://github.com/betfint/betfint/blob/master/doc/release-process.md#setup-and-perform-gitian-builds) in the betfint repository.
...
Output from `gbuild` will look something like
    ...
    Initialized empty Git repository in /home/gitianuser/gitian-builder/inputs/betfint/.git/
    remote: Counting objects: 57959, done.
    remote: Total 57959 (delta 0), reused 0 (delta 0), pack-reused 57958
    Receiving objects: 100% (57959/57959), 53.76 MiB | 484.00 KiB/s, done.
    Resolving deltas: 100% (41590/41590), done.
    From https://github.com/betfint/betfint
...
For example:
```bash
URL=https://github.com/BetfintTor/betfint.git
...
BETFPATH=/some/root/path/betfint
SIGPATH=/some/root/path/betfint-detached-sigs

./bin/gbuild --url betfint=${BETFPATH},signature=${SIGPATH} ../betfint/contrib/gitian-descriptors/gitian-win-signer.yml
```
...
and follow the steps in the build process as normal.
    ...
    gpg: skipped "betfinttor": secret key not available
...
[betfint/gitian.sigs](https://github.com/betfint/gitian.sigs/) repository, or if that's not possible create a pull
