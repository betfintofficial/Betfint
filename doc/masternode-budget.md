...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<betfint_address\> \<monthly_payment_betfint\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ Betfint, _12_ times over the course of a year totaling _24000_ Betfint.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<betfint_address\> \<monthly_payment_betfint\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` Betfint.
