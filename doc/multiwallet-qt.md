...
In order to support loading of multiple wallets in betfint-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is betfint.cpp.
...
Changes to betfint.cpp
----------------------
betfint.cpp is the entry point into betfint-qt, and as such, will require some minor modifications to provide hooks for
