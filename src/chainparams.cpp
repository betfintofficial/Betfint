...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    // BetfintDevs - RELEASE CHANGE - Checkpoins, timestamp of last checkpoint, total nr. of transactions
	(       0, uint256("0x5a5d7f6c5b5084000b3058a0b9fa80e4834bcd555c2638ae754b03ad3a9afb50"));
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 8232;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Betfint starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60;              // BETFINT: 1 day
        nTargetSpacing = 3 * 60;               // BETFINT: 1 minute
        nMaturity = 100;
        nMasternodeCountDrift = 20;
        //nMaxMoneyOut = 398360470 * COIN;
        nMaxMoneyOut = 190000000 * COIN;
        ...
        strOracleWalletAddr = "fB3KnGngTepx9MehjUPzYKPfac2EWrJbYr";     // Oracle Masternode Event & Result Posting Wallet Address.
        ...
        strDevPayoutAddr = "f5c9KZCQ7TMG7CmWR9w3hfbKfVonDn4KXJ";        // Development fund payout address.
        strOMNOPayoutAddr = "f5c9KZCQ7TMG7CmWR9w3hfbKfVonDn4KXJ";       // OMNO fund payout address.
        ...
        assert(hashGenesisBlock == uint256("0xa1e5a3e698880ff888ada9e844a1c0cec4adf3f2104ba46cac497d04fb9c667c"));
        assert(genesis.hashMerkleRoot == uint256("0x482b983413e9e4e1585ed67343dd50c2717ecfbc097cdd8b5a634e07adb9dbbb"));

        vSeeds.push_back(CDNSSeedData("1", "dns1.betfint.xyz"));      // Betfint's official seed 1
        vSeeds.push_back(CDNSSeedData("2", "dns2.betfint.xyz"));      // Betfint's official seed 2
        vSeeds.push_back(CDNSSeedData("3", "dns3.betfint.xyz"));    // Betfint's dev1 testseed
        vSeeds.push_back(CDNSSeedData("4", "dns4.betfint.xyz"));    // Betfint's dev2 testseed
        vSeeds.push_back(CDNSSeedData("5", "dns5.betfint.xyz"));
        vSeeds.push_back(CDNSSeedData("6", "dns6.betfint.xyz"));
        vSeeds.push_back(CDNSSeedData("7", "dns7.betfint.xyz"));
        vSeeds.push_back(CDNSSeedData("8", "dns8.betfint.xyz"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 94);   // betfint addresses start with 'W'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);   // betfint script addresses start with '7'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 35);      // betfint private keys start with '7' or 'W'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x02)(0x2D)(0x25)(0x33).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x02)(0x21)(0x31)(0x2B).convert_to_container<std::vector<unsigned char> >();
        // 	BIP44 coin type is from https://github.com/satoshilabs/slips/blob/master/slip-0044.md
        base58Prefixes[EXT_COIN_TYPE] = boost::assign::list_of(0x80)(0x77)(0x67)(0x72).convert_to_container<std::vector<unsigned char> >(); // betf in hex: 776772
        ...
        strObfuscationPoolDummyAddress = "exniBgwXjWrcgXQLypvP9oUAsPwuRZK2Kk";
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zbetf to be stakable
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // BETFINT: 1 day
        nTargetSpacing = 1 * 60;  // BETFINT: 1 minute
        nLastPOWBlock = 300;
        nMaturity = 15;
    ...
    //    assert(hashGenesisBlock == uint256("0x00000fdc268f54ff1368703792dc046b1356e60914c2b5b6348032144bcb2de5"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("1", "test.testseederv1.betf.host")); // Betfint's official testseed 1
        vSeeds.push_back(CDNSSeedData("2", "test.testseederv2.betf.host")); // Betfint's official testseed 2
        vSeeds.push_back(CDNSSeedData("3", "test.devseeder1.betf.host"));   // Betfint's dev1 testseed
        vSeeds.push_back(CDNSSeedData("4", "test.devseeder2.betf.host"));   // Betfint's dev2 testseed

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 65);   // Testnet betfint addresses start with 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 125);  // Testnet betfint script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 177);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet betfint BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet betfint BIP32 prvkeys start with 'DRKP'
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // BETFINT: 1 day
        nTargetSpacing = 1 * 60;        // BETFINT: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        genesis.nTime = 1518696183;             // GMT: Thursday, 15. February 2018 12:03:03
        genesis.nBits = 0x207fffff;
        genesis.nNonce = 574752;                // hex 57 47 52 in text = BETF
