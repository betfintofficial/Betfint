/* src/config/betfint-config.h.  Generated from betfint-config.h.in by configure.  */
/* src/config/betfint-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BETF_CONFIG_H

#define BETF_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.betfint.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Betfint Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Betfint Core 2.0.99"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "betfint"
