...
public:
    ...
    {
        // "Dust" is defined in terms of CTransaction::minRelayTxFee, which has units ubetf-per-kilobyte.
        // If you'd pay more than 1/3 in fees to spend something, then we consider it dust.
        // A typical txout is 34 bytes big, and will need a CTxIn of at least 148 bytes to spend
        // i.e. total is 148 + 32 = 182 bytes. Default -minrelaytxfee is 100000 ubetf per kB
        // and that means that fee per txout is 182 * 100000 / 1000 = 18200 ubetf.
        // So dust is a txout less than 1820 *3 = 54600 ubetf
        // with default -minrelaytxfee = minRelayTxFee = 100000 ubetf per kB.
