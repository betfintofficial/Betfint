                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zBETF || context == Context::BIP_38) {
    ...
    // It doesn't make sense to show the checkbox for sending BETF because you wouldn't check it anyway.
    if (context == Context::Send_BETF || context == Context::Send_zBETF) {
            ...
            if (newpass1 == newpass2) {
                if (model->setWalletEncrypted(true, newpass1)) {
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                        "<qt>" +
                            tr("BETFINT will close now to finish the encryption process. "
                               "Remember that encrypting your wallet cannot fully protect "
                               "your BETFs from being stolen by malware infecting your computer.") +
                            "<br><br><b>" +
