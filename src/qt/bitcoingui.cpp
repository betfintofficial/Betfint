                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Betfint Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zBETF"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Betfint Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BETFINT"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Betfint Core help message to get a list with possible Betfint command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Betfint Core client") + " " + networkStyle->getTitleAddText();
