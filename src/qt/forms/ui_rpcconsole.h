...
public:
    ...
    QLabel *wallet_customzwgrbackuppath_label;
    QLabel *wallet_customzwgrbackuppath;
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        wallet_customzwgrbackuppath_label = new QLabel(tab_repair);
        wallet_customzwgrbackuppath_label->setObjectName(QStringLiteral("wallet_customzwgrbackuppath_label"));
        wallet_customzwgrbackuppath_label->setVisible(false);

        gridLayout_4->addWidget(wallet_customzwgrbackuppath_label, 4, 0, 1, 1);

        wallet_customzwgrbackuppath = new QLabel(tab_repair);
        wallet_customzwgrbackuppath->setObjectName(QStringLiteral("wallet_customzwgrbackuppath"));
        wallet_customzwgrbackuppath->setCursor(QCursor(Qt::IBeamCursor));
        wallet_customzwgrbackuppath->setTextFormat(Qt::PlainText);
        wallet_customzwgrbackuppath->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);
        wallet_customzwgrbackuppath->setVisible(false);

        gridLayout_4->addWidget(wallet_customzwgrbackuppath, 4, 1, 1, 3);
    ...
    void retranslateUi(QDialog *RPCConsole)
    {
        ...
        dataDirLabel->setText(QApplication::translate("RPCConsole", "Datadir", Q_NULLPTR));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the Betfint debug log file from the current data directory. This can take a few seconds for large log files.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        wallet_customzwgrbackuppath_label->setText(QApplication::translate("RPCConsole", "Custom zBETF Backup Path:", Q_NULLPTR));
        wallet_customzwgrbackuppath->setText(QApplication::translate("RPCConsole", "N/A", Q_NULLPTR));
