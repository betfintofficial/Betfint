...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a Betfint address (e.g. %1)").arg("WXXcvsJf4NJj3eCp5XhHP3qp5vHWGBVmbP"));
#endif
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "BETFINT.lnk";
}

bool GetStartOnSystemStartup()
{
    // check for BETFINT.lnk
...
{
    return GetAutostartDir() / "betfint.desktop";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    if (!fAutoStart)
        ...
        if (!optionFile.good())
            return false;
        // Write a betfint.desktop file to the autostart directory:
        optionFile << "[Desktop Entry]\n";
        optionFile << "Type=Application\n";
        optionFile << "Name=BETFINT\n";
...
LSSharedFileListItemRef findStartupItemInList(LSSharedFileListRef list, CFURLRef findUrl)
{
    // loop through the list of startup items and try to find the betfint app
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart && !foundItem) {
        // add betfint app to startup item list
