...
QT_MOC_LITERAL(7, 108, 29), // "anonymizeBetfintAmountChanged"
QT_MOC_LITERAL(8, 138, 26), // "coinControlFeaturesChanged"
QT_MOC_LITERAL(9, 165, 23) // "hideZeroBalancesChanged"

    },
    "OptionsModel\0displayUnitChanged\0\0unit\0"
    "zeromintEnableChanged\0zeromintPercentageChanged\0"
    "preferredDenomChanged\0"
    "anonymizeBetfintAmountChanged\0"
...
void OptionsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->anonymizeBetfintAmountChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            typedef void (OptionsModel::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OptionsModel::anonymizeBetfintAmountChanged)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 4
void OptionsModel::anonymizeBetfintAmountChanged(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
