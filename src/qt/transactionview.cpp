 ...
 */
    ...
    typeWidget->addItem(tr("Minted"), TransactionFilterProxy::TYPE(TransactionRecord::StakeMint) | TransactionFilterProxy::TYPE(TransactionRecord::StakeZBETF));
    ...
    typeWidget->addItem(tr("Received BETF from zBETF"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zBETF"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zBetf));
