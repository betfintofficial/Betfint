...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total betfint balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zBETFsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zBETF denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zBETF denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zBETF denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zBETF denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zBETF denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zBETF denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zBETF denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zBETF denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zBETF denominations\n"
            "  }\n"
            "  \"keypoololdest\": xxxxxx,    (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,        (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,      (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in betfint/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in betfint/kb\n"
    ...
    UniValue zbetfObj(UniValue::VOBJ);
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zbetfObj.push_back(Pair(to_string(denom), ValueFromAmount(chainActive.Tip()->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zbetfObj.push_back(Pair("total", ValueFromAmount(chainActive.Tip()->GetZerocoinSupply())));
    obj.push_back(Pair("zBETFsupply", zbetfObj));
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"betfintaddress\"\n"
            "\nReturn information about the given betfint address.\n"

            "\nArguments:\n"
            "1. \"betfintaddress\"     (string, required) The betfint address to validate\n"

            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"betfintaddress\", (string) The betfint address validated\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"betfintaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"

            "\nArguments:\n"
            "1. \"betfintaddress\"  (string, required) The betfint address to use for the signature.\n"
