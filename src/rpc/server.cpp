...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "BETFINT server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Betfint features */
        {"betfint", "masternode", &masternode, true, true, false},
        {"betfint", "listmasternodes", &listmasternodes, true, true, false},
        {"betfint", "getmasternodecount", &getmasternodecount, true, true, false},
        {"betfint", "masternodeconnect", &masternodeconnect, true, true, false},
        {"betfint", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"betfint", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"betfint", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"betfint", "masternodecurrent", &masternodecurrent, true, true, false},
        {"betfint", "masternodedebug", &masternodedebug, true, true, false},
        {"betfint", "startmasternode", &startmasternode, true, true, false},
        {"betfint", "createmasternodekey", &createmasternodekey, true, true, false},
        {"betfint", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"betfint", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"betfint", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"betfint", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"betfint", "getmasternodescores", &getmasternodescores, true, true, false},
        {"betfint", "mnbudget", &mnbudget, true, true, false},
        {"betfint", "preparebudget", &preparebudget, true, true, false},
        {"betfint", "submitbudget", &submitbudget, true, true, false},
        {"betfint", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"betfint", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"betfint", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"betfint", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"betfint", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"betfint", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"betfint", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"betfint", "checkbudgets", &checkbudgets, true, true, false},
        {"betfint", "mnsync", &mnsync, true, true, false},
        {"betfint", "spork", &spork, true, true, false},
        {"betfint", "getpoolinfo", &getpoolinfo, true, true, false},
        {"betfint", "listevents", &listevents, false, false, false},
        ...
        {"zerocoin", "getzbetfseed", &getzbetfseed, false, false, true},
        {"zerocoin", "setzbetfseed", &setzbetfseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzbetf", &searchdzbetf, false, false, true},
        {"zerocoin", "dzbetfstate", &dzbetfstate, false, false, true}
