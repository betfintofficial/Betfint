...
#ifndef BETFINT_STAKEINPUT_H
#define BETFINT_STAKEINPUT_H
...
public:
    ...
    bool IsZBETF() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZBETF() override { return false; }
};


#endif //BETFINT_STAKEINPUT_H
